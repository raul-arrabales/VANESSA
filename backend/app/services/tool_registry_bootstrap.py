...
_BUILTIN_TOOLS: dict[str, dict[str, object]] = {
    ...
    "tool.image_text_to_image": {
        ...
        "execution_config": {"tasks": ["text_to_image"]},
        "permissions": {},
    },
...
_BUILTIN_MCP_SERVERS: dict[str, dict[str, object]] = {
    ...
    "mcp.image_text_to_image": {
        "name": "Text to Image",
        "slug": "image_text_to_image",
        "description": "Expose the local text-to-image generation tool.",
        "backing_tool_id": "tool.image_text_to_image",
        "exposed_tool_name": "image_text_to_image",
        "input_schema": _BUILTIN_TOOLS["tool.image_text_to_image"]["input_schema"],
        "output_schema": _BUILTIN_TOOLS["tool.image_text_to_image"]["output_schema"],
        "metadata": {
    ...
    "mcp.image_plate_logo_replacement": {
        "name": "Plate Logo Replacement",
        "slug": "image_plate_logo_replacement",
        "description": "Expose the local license plate logo replacement tool.",
        "backing_tool_id": "tool.image_plate_logo_replacement",
        "exposed_tool_name": "image_plate_logo_replacement",
        "input_schema": _BUILTIN_TOOLS["tool.image_plate_logo_replacement"]["input_schema"],
        "output_schema": _BUILTIN_TOOLS["tool.image_plate_logo_replacement"]["output_schema"],
        "metadata": {
            "category": "creative_media",
            "capabilities": ["image-generation", "image-editing", "license-plate-logo-replacement"],
            "local": True,
            "stateless": True,
            "sandboxed": False,
            "risk_level": "medium",
