...
REQUIRED_CAPABILITIES = {CAPABILITY_LLM_INFERENCE, CAPABILITY_EMBEDDINGS, CAPABILITY_VECTOR_STORE, CAPABILITY_MCP_RUNTIME}
OPTIONAL_CAPABILITIES = {CAPABILITY_SANDBOX_EXECUTION, CAPABILITY_IMAGE_ANALYSIS, CAPABILITY_IMAGE_GENERATION, CAPABILITY_WEB_SEARCH}
