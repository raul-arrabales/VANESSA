...
_SYNC_RUN_OPERATION_TYPES = {"source_sync", "knowledge_resync"}
_SYNC_RUN_STATES = {"queued", "running", "ready", "error"}
_DEFAULT_CHUNK_SIZE = 1000
_DEFAULT_EMBEDDINGS_SAFE_CHUNK_SIZE = 650
MAX_INGESTION_FILE_SIZE_BYTES = 20 * 1024 * 1024
MAX_INGESTION_FILE_SIZE_LABEL = "20 MB"
_MAX_FILE_SIZE_BYTES = MAX_INGESTION_FILE_SIZE_BYTES
