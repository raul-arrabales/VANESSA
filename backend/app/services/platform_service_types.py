...
from .image_generation_tasks import (
    IMAGE_GENERATION_MODEL_DEFAULT_KEYS as _IMAGE_GENERATION_MODEL_DEFAULT_KEYS,
    IMAGE_GENERATION_TASK_DEFAULT_KEYS as _IMAGE_GENERATION_TASK_DEFAULT_KEYS,
    IMAGE_GENERATION_TASK_GROUPS as _IMAGE_GENERATION_TASK_GROUPS,
    TASK_KEY_TEXT_TO_IMAGE as _TASK_KEY_TEXT_TO_IMAGE,
)
...
_TASK_KEY_LLM = "llm"
_TASK_KEY_IMAGE_TEXT_TO_IMAGE = _TASK_KEY_TEXT_TO_IMAGE
_CLOUD_PROVIDER_KEYS = {"openai_compatible_cloud_llm", "openai_compatible_cloud_embeddings"}
_MODEL_BEARING_CAPABILITIES = {CAPABILITY_LLM_INFERENCE, CAPABILITY_EMBEDDINGS, CAPABILITY_IMAGE_ANALYSIS, CAPABILITY_IMAGE_GENERATION}
