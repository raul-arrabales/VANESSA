...
describe("agent-builder boundaries", () => {
  it("legacy agent-builder routes are retired", () => {
    expect(routesSource).not.toContain('../features/agent-builder/pages/AgentBuilderProjectsPage');
    expect(routesSource).not.toContain('../features/agent-builder/pages/AgentProjectDetailPage');
  });
